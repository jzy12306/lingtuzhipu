...
class PromptTemplateManager:
    ...
    def _initialize_templates(self) -> Dict[str, Dict[str, str]]:
        ...
        return {
            "通用": {
            "entity_extraction": """
你是一个专业的知识图谱构建助手，请从以下文本中提取所有可能的实体。每个实体应该包含名称、类型和简要描述。
...
""",
            "relation_extraction": """
你是一个专业的知识图谱构建助手，请从以下文本中提取实体之间的所有可能关系。每个关系应该包含源实体、目标实体、关系类型和简要描述。
